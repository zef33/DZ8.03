...
2. `Устанавливаем и настраиваем HAProxy, конфигурационный файл [Руководство по оформлению Markdown файлов](https://gist.github.com/Jekins/2bf2d0638163f1294637#Code) [haproxy.cfg](https://github.com/zef33/DZ8.03/blob/Balans/задание1/haproxy.cfg)  скриншот 3`
